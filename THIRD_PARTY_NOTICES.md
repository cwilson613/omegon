...
The vast majority of Omegon's dependencies are licensed under permissive terms:

| License | Approximate count | Notes |
|---|---|---|
| Apache-2.0 OR MIT | ~510 packages | Standard Rust ecosystem |
| MIT | ~195 packages | Standard permissive |
| Apache-2.0 | ~53 packages | |
| BSD-2-Clause / BSD-3-Clause | ~11 packages | |
...
The following packages are licensed under the **Mozilla Public License 2.0 (MPL-2.0)**. MPL-2.0 is a file-level copyleft license: if you distribute a modified version of these specific files, you must make the modified source available. Use of these files in unmodified form as dependencies (as Omegon does) does not require disclosure of other source code.

The unmodified source for each package is available at the links below.

### colored v3.1.1

Terminal text coloring for Rust.

- **License:** MPL-2.0
- **Copyright:** © 2015 Thomas Wickham and contributors
...
- **License:** MPL-2.0
- **Copyright:** © Jan-Willem Harmannij and contributors
- **Source:** https://github.com/soc/option-ext
- **crates.io:** https://crates.io/crates/option-ext

### uluru v3.1.0

A simple, fast LRU cache.
...
For components licensed under Apache-2.0, a copy of the Apache License 2.0 is available at:  
...
For a machine-readable list of all dependencies and their declared licenses, run:
...
1.11. "Patent Claims" of a Contributor
    ...
    License, to make, use, sell, offer for sale, have made, import, or
...
1.14. "You" (or "Your")
    ...
    entitled to vote for the election of directors (as the case may be).
...
describe the limitations and the reasons for them. Such description must
...
any necessary servicing, repair, or modification. This disclaimer of
...
such party shall have been advised of the possibility of such damages.
...
modified version of this License as long as you rename the license and
